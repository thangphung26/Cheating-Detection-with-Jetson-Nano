...
def GetColumnNames(dim=None):
    ...
    # return columnNames
    if dim == "x" or dim == "X":
        return ['kp0_X', 'kp1_X', 'kp2_X', 'kp3_X', 'kp4_X', 'kp5_X', 'kp6_X', 'kp7_X', 'kp8_X', 'kp9_X', 'kp10_X', 'kp11_X', 'kp12_X',
            'kp13_X', 'kp14_X', 'kp15_X', 'kp16_X', 'kp17_X']

    if dim == "y" or dim == "Y":
        return ['kp0_Y', 'kp1_Y', 'kp2_Y', 'kp3_Y', 'kp4_Y', 'kp5_Y', 'kp6_Y', 'kp7_Y', 'kp8_Y', 'kp9_Y', 'kp10_Y', 'kp11_Y',
                'kp12_Y', 'kp13_Y', 'kp14_Y', 'kp15_Y', 'kp16_Y', 'kp17_Y']

    if dim == "z" or dim == "Z":
        return ['kp0_Z', 'kp1_Z', 'kp2_Z', 'kp3_Z', 'kp4_Z', 'kp5_Z', 'kp6_Z', 'kp7_Z', 'kp8_Z', 'kp9_Z', 'kp10_Z', 'kp11_Z', 'kp12_Z',
                'kp13_Z', 'kp14_Z', 'kp15_Z', 'kp16_Z', 'kp17_Z']
